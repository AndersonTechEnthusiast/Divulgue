                    ...
                    <div class="Front">
                        <form action="Atualizar.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="Container-Inputs">
                                <input type="file" name="image_carrousel" id="Preview_File">
                                <div class="Imagem-Preview">
                                    <label for="Preview_File">
                                        <img src="../../Image-From-To-o-que-temos/<?php echo $imagem;?>" alt="imagem" id="Preview_Image">
                                    </label>
                                </div>
                                <input type="hidden" name="id" value="<?php echo $id;?>">
                                <input type="hidden" name="image_carrousel" value="">
                                <input type="hidden" name="image_carrousel_atualizada" value="image_carrousel">
                                <div class="btn-acion">
